export const categories = [
  {
    ...
    image: '/assets/fabric-painting.jpg',
    startingPrice: 50,
  ...
  },
  {
    ...
    image: '/assets/embroidery-works.jpg',
    startingPrice: 80,
...
export const products = [
  {
    ...
    image: '/assets/product-1.jpg', colors: ['White', 'Black', 'Pastel Pink'], sizes: ['S', 'M', 'L', 'XL']
  },
  {
    ...
    image: '/assets/product-2.jpg', colors: ['White', 'Sky Blue', 'Cream'], sizes: ['S', 'M', 'L', 'XL']
  },
  {
    ...
    image: '/assets/product-3.jpg', colors: ['Black', 'White', 'Navy'], sizes: ['S', 'M', 'L', 'XL']
  },
  {
    ...
    image: '/assets/product-4.jpg', colors: ['White', 'Black'], sizes: ['S', 'M', 'L', 'XL']
  },
  {
    ...
    image: '/assets/product-5.jpg', colors: ['Red', 'Green', 'Yellow'], sizes: ['S', 'M', 'L', 'XL']
  },
  {
    ...
    image: '/assets/product-6.jpg', colors: ['White', 'Cream'], sizes: ['Free Size']
  },
  {
    ...
    image: '/assets/product-7.jpg', colors: ['White', 'Ivory', 'Gold'], sizes: ['S', 'M', 'L', 'XL', 'XXL']
  },
  {
    ...
    image: '/assets/product-8.jpg', colors: ['Black', 'White', 'Maroon'], sizes: ['S', 'M', 'L', 'XL']
  }
];
...
export const reviews = [
  {
    ...
    avatar: '/assets/review-1.jpg', date: '2024-12-15', hasVideo: false
  },
  {
    ...
    avatar: '/assets/review-2.jpg', date: '2025-01-20', hasVideo: true
  },
  {
    ...
    avatar: '/assets/review-3.jpg', date: '2025-02-08', hasVideo: false
  },
  {
    ...
    avatar: '/assets/review-4.jpg', date: '2025-03-01', hasVideo: false
  },
  {
    ...
    avatar: '/assets/review-5.jpg', date: '2025-03-15', hasVideo: true
  },
  {
    ...
    avatar: '/assets/review-6.jpg', date: '2025-04-02', hasVideo: false
  }
];

export const galleryImages = [
  { id: 1, src: '/assets/gallery-1.jpg', category: 'embroidery', title: 'Royal Floral Embroidery', likes: 234 },
  { id: 2, src: '/assets/gallery-2.jpg', category: 'fabric-painting', title: 'Sunset Paradise Tee', likes: 187 },
  { id: 3, src: '/assets/gallery-3.jpg', category: 'combo', title: 'Wedding Special Combo', likes: 312 },
  { id: 4, src: '/assets/gallery-4.jpg', category: 'embroidery', title: 'Name Art Collection', likes: 156 },
  { id: 5, src: '/assets/gallery-5.jpg', category: 'fabric-painting', title: 'Anime Character Art', likes: 445 },
  { id: 6, src: '/assets/gallery-6.jpg', category: 'customer', title: 'Customer Creation', likes: 98 },
  { id: 7, src: '/assets/gallery-7.jpg', category: 'combo', title: 'Festival Special', likes: 267 },
  { id: 8, src: '/assets/gallery-8.jpg', category: 'embroidery', title: 'Sleeve Detail Work', likes: 189 },
  { id: 9, src: '/assets/gallery-9.jpg', category: 'fabric-painting', title: 'Butterfly Collection', likes: 334 },
  { id: 10, src: '/assets/gallery-10.jpg', category: 'customer', title: 'Happy Customer', likes: 121 },
  { id: 11, src: '/assets/gallery-11.jpg', category: 'embroidery', title: 'Mirror Work Design', likes: 278 },
  { id: 12, src: '/assets/gallery-12.jpg', category: 'combo', title: 'Couple Set', likes: 399 },
];

export const instagramPosts = [
  { id: 'ig1', mediaUrl: '/assets/insta-1.jpg', caption: 'New floral embroidery collection dropping soon! 🌸✨ #DharshiniCreations', permalink: 'https://instagram.com' },
  { id: 'ig2', mediaUrl: '/assets/insta-2.jpg', caption: 'Behind the scenes — hand-painting this gorgeous tee 🎨 #HandmadeWithLove', permalink: 'https://instagram.com' },
  { id: 'ig3', mediaUrl: '/assets/insta-3.jpg', caption: 'Customer order ready! Every stitch tells a story 🪡 #EmbroideryArt', permalink: 'https://instagram.com' },
  { id: 'ig4', mediaUrl: '/assets/insta-4.jpg', caption: 'Festival collection is HERE 🎉 Limited pieces available! #FestivalFashion', permalink: 'https://instagram.com' },
  { id: 'ig5', mediaUrl: '/assets/insta-5.jpg', caption: 'Custom anime tee for a happy customer! 🎌 #AnimeFashion #CustomArt', permalink: 'https://instagram.com' },
  { id: 'ig6', mediaUrl: '/assets/insta-6.jpg', caption: 'The magic of needle and thread ✨ #Handcrafted #PremiumQuality', permalink: 'https://instagram.com' },
];
