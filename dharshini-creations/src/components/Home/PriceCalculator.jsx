    ...
    <section ref={ref} className="relative">
      <div className="section-container">
        ...
        <motion.div className="max-w-3xl mx-auto mt-8 glass-card p-8" initial={{ opacity: 0, y: 40 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.2 }}>
          <div className="mb-8">
            <h4 className="font-cinzel text-sm font-semibold tracking-widest mb-4 text-left" style={{ color: '#E5E7EB' }}>SHIRT TYPE</h4>
            <div className="flex gap-4">
              {[{ value: 'tshirt', label: 'T-Shirt', price: '₹199', emoji: '👕', color: '#2DD4BF' }, { value: 'shirt', label: 'Formal Shirt', price: '₹399', emoji: '👔', color: '#F59E0B' }].map(type => (
                <button key={type.value} onClick={() => setShirtType(type.value)} className="flex-1 p-5 rounded-xl text-center interactive transition-all"
                  ...
                  <p className="font-poppins font-semibold text-sm" style={{ color: shirtType === type.value ? '#F5F5F5' : '#E5E7EB' }}>{type.label}</p>
          ...
          <div className="mb-8">
            <h4 className="font-cinzel text-sm font-semibold tracking-widest mb-4 text-left" style={{ color: '#E5E7EB' }}>ADD-ONS</h4>
          ...
          <div className="mb-8">
            <h4 className="font-cinzel text-sm font-semibold tracking-widest mb-4 text-left" style={{ color: '#E5E7EB' }}>SHIPPING</h4>
          ...
          <div className="p-6 rounded-2xl text-center" style={{ background: 'linear-gradient(135deg, rgba(52,211,153,0.15), rgba(45,212,191,0.08))' }}>
            <p className="text-xs font-poppins tracking-widest mb-2" style={{ color: '#E5E7EB' }}>ESTIMATED TOTAL</p>
