    ...
    <section ref={ref} className="relative gradient-bg overflow-hidden">
      <div className="section-container">
        ...
        <motion.div className="text-center mb-10" initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}}>
          <p className="font-great-vibes text-2xl mb-2" style={{ color: '#A78BFA' }}>Our Story</p>
          <h2 className="font-cinzel text-3xl md:text-4xl font-bold glow-text mb-4"
            style={{ background: 'linear-gradient(135deg, #FAFAFA, #7C3AED)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
        ...
        <div className="max-w-3xl mx-auto mb-16">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.3 }}>
            <h3 className="font-cinzel text-2xl font-bold mb-6 glow-text text-center" style={{ color: '#FAFAFA' }}>Meet the Artist</h3>
        ...
        {/* Our Values - matches About page values cards */}
        <div className="mb-16">
          <h3 className="section-title glow-text mb-10">Our Values</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((v, i) => (
              <motion.div key={v.title} className="glass-card overflow-hidden group" initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.4 + i * 0.1 }} whileHover={{ y: -6 }}>
