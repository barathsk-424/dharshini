                ...
                >
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 mt-4">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-widest px-2.5 py-1 rounded" style={{ background: order.status === 'delivered' ? 'rgba(16,185,129,0.1)' : 'rgba(245,158,11,0.1)', color: order.status === 'delivered' ? 'var(--color-success)' : 'var(--color-gold)' }}>
                        {order.status}
                      </span>
                    </div>
                  </div>
