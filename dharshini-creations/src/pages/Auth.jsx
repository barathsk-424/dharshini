...
import {
  ...
  FiLogOut, FiShoppingBag, FiEye, FiEyeOff,
} from 'react-icons/fi';
...
export default function Auth() {
  ...
  // ── Already logged in — show profile dashboard ───────────
  if (currentUser) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <div className="relative z-10 text-center">
                  ...
                  <button
                    ...
                    className="btn-ghost w-full interactive flex items-center justify-center gap-2 mt-8 py-3.5 border-purple-500/30 text-purple-400 hover:text-white"
                  >
            ...
            <div className="md:col-span-2">
              ...
              >
                ...
                <h2 className="font-cinzel text-2xl font-bold text-white mb-6 border-b border-white/10 pb-4 glow-text">
                  Order History
                </h2>
                    ...
                    orders.map(order => (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between md:justify-end gap-4">
                          ...
                          <Link to="/track-order" className="text-xs text-purple-400 hover:text-purple-300 font-semibold interactive">
                            Track
                          </Link>
                        </div>
                      </div>
  ...
  return (
    ...
    >
      <Helmet>
        <title>{isLogin ? 'Sign In' : 'Create Account'} — Dharshini Creations</title>
      </Helmet>
      <div className="w-full max-w-md animate-fade-in">
        ...
        >
          ...
          <div className="relative z-10 text-center mb-8">
            ...
            <h1
              className="font-cinzel text-3xl font-bold mb-2 glow-text"
              style={{
            ...
            <p className="text-sm" style={{ color: 'var(--color-gray-dark)' }}>
              {isLogin
                ? 'Sign in to access your custom orders and wishlist'
          ...
          <form onSubmit={handleSubmit} className="relative z-10">
            {error && (
              <div className="mb-5 p-3.5 rounded-xl border border-red-500/20 bg-red-500/10 text-red-300 text-xs font-semibold text-center">
                ⚠️ {error}
              </div>
            )}
              ...
              {!isLogin && (
                ...
                >
                  ...
                  <div className="relative">
                    <div className="absolute left-4 top-1/2 -translate-y-1/2 text-purple-400 z-10 pointer-events-none">
                      <FiUser size={16} />
                    </div>
                    <input
                      type="text"
                      ...
                      style={{
                        ...
                        WebkitBoxShadow: '0 0 0 1000px rgba(12,8,22,0.9) inset',
            ...
            <div className="mb-5">
              <div className="flex items-center justify-between mb-2">
                ...
                {isLogin && (
                  <a href="#" className="text-xs hover:text-purple-400 transition-colors" style={{ color: 'var(--color-purple-glow)' }}>
                    Forgot?
                  </a>
                )}
              </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="btn-primary w-full interactive flex items-center justify-center gap-2 mt-4 py-3.5 shadow-[0_0_20px_rgba(138,43,226,0.3)] disabled:opacity-70 disabled:cursor-not-allowed"
            >
